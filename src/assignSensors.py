...
Utility that shows all OneWire temp sensors on the bus and allows you to assign
them to the rooms and writes the configuration to the sensors_config.py file.
"""
...
def multi_threaded_file_reader(ROOMS) -> list[str]:
    threads = []
    results = {}
...
def reassign_sensors_to_rooms() -> None:
